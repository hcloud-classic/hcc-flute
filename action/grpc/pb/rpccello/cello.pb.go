...
var file_cello_proto_rawDesc = []byte{
	...
	,
...
var file_cello_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_cello_proto_goTypes = []interface{}{
	...
	(*rpcmsgType.Volume)(nil),   // 4: MsgType.Volume
	(*rpcmsgType.HccError)(nil), // 5: MsgType.HccError
	(*rpcmsgType.Pool)(nil),     // 6: MsgType.Pool
}
var file_cello_proto_depIdxs = []int32{
	4, // 0: RpcCello.ReqVolumeHandler.volume:type_name -> MsgType.Volume
	4, // 1: RpcCello.ResVolumeHandler.volume:type_name -> MsgType.Volume
	5, // 2: RpcCello.ResVolumeHandler.hccErrorStack:type_name -> MsgType.HccError
	6, // 3: RpcCello.ReqPoolHandler.pool:type_name -> MsgType.Pool
	6, // 4: RpcCello.ResPoolHandler.pool:type_name -> MsgType.Pool
	5, // 5: RpcCello.ResPoolHandler.hccErrorStack:type_name -> MsgType.HccError
	0, // 6: RpcCello.Cello.VolumeHandler:input_type -> RpcCello.ReqVolumeHandler
	2, // 7: RpcCello.Cello.PoolHandler:input_type -> RpcCello.ReqPoolHandler
	1, // 8: RpcCello.Cello.VolumeHandler:output_type -> RpcCello.ResVolumeHandler
	3, // 9: RpcCello.Cello.PoolHandler:output_type -> RpcCello.ResPoolHandler

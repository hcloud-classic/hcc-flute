...
type ReqMetricInfo struct {
	...
	MetricInfo []*rpcmsgType.MetricInfo `protobuf:"bytes,1,rep,name=metricInfo,proto3" json:"metricInfo,omitempty"`
}
...
type ResSeries struct {
	...
	Series []*rpcmsgType.Series `protobuf:"bytes,1,rep,name=series,proto3" json:"series,omitempty"`
}

func (x *ResSeries) Reset() {
	*x = ResSeries{}
	if protoimpl.UnsafeEnabled {
...
func (x *ResSeries) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ResSeries) ProtoMessage() {}

func (x *ResSeries) ProtoReflect() protoreflect.Message {
	mi := &file_piano_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ResSeries.ProtoReflect.Descriptor instead.
func (*ResSeries) Descriptor() ([]byte, []int) {
	return file_piano_proto_rawDescGZIP(), []int{1}
}

func (x *ResSeries) GetSeries() []*rpcmsgType.Series {
	if x != nil {
		return x.Series
	}
	return nil
...
var file_piano_proto_rawDesc = []byte{
	...
	,
}
...
var file_piano_proto_goTypes = []interface{}{
	...
	(*ResSeries)(nil),             // 1: RpcPiano.ResSeries
	(*rpcmsgType.MetricInfo)(nil), // 2: MsgType.MetricInfo
	(*rpcmsgType.Series)(nil),     // 3: MsgType.Series
}
var file_piano_proto_depIdxs = []int32{
	2, // 0: RpcPiano.ReqMetricInfo.metricInfo:type_name -> MsgType.MetricInfo
	3, // 1: RpcPiano.ResSeries.series:type_name -> MsgType.Series
	0, // 2: RpcPiano.Piano.Telegraph:input_type -> RpcPiano.ReqMetricInfo
	1, // 3: RpcPiano.Piano.Telegraph:output_type -> RpcPiano.ResSeries

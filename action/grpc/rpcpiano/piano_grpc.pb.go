...
type PianoClient interface {
	Telegraph(ctx context.Context, in *ReqMetricInfo, opts ...grpc.CallOption) (*ResSeries, error)
}
...
func (c *pianoClient) Telegraph(ctx context.Context, in *ReqMetricInfo, opts ...grpc.CallOption) (*ResSeries, error) {
	out := new(ResSeries)
...
type PianoServer interface {
	Telegraph(context.Context, *ReqMetricInfo) (*ResSeries, error)
...
func (*UnimplementedPianoServer) Telegraph(context.Context, *ReqMetricInfo) (*ResSeries, error) {
